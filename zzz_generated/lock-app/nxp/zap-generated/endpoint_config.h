...
\
  ...
  { (uint16_t)0x5A0, (uint16_t)0x1, (uint16_t)0xB40 } /* ExpiringUserTimeout */ \
}
...
\
  ...
  { 0x00000025, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(0) }, /* OperatingMode */  \
  { 0x00000026, ZAP_TYPE(BITMAP16), 2, 0, ZAP_SIMPLE_DEFAULT(0xFFF6) }, /* SupportedOperatingModes */  \
  { 0x00000035, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(1) }, /* ExpiringUserTimeout */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 11, 147 }, \
  { ZAP_CLUSTER_INDEX(11), 3, 36 }, \
}
