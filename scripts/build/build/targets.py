...
def IMXTargets():
    ...
    yield target.Extend('chip-tool-trusty', app=IMXApp.CHIP_TOOL_TRUSTY)
    yield target.Extend('lighting-app', app=IMXApp.LIGHT)
    yield target.Extend('lighting-app-trusty', app=IMXApp.LIGHT_TRUSTY)
    yield target.Extend('thermostat', app=IMXApp.THERMOSTAT)
    yield target.Extend('nxp-thermostat', app=IMXApp.NXP_THERMOSTAT)
    yield target.Extend('nxp-thermostat-trusty', app=IMXApp.NXP_THERMOSTAT_TRUSTY)
    ...
    yield target.Extend('chip-tool-trusty-release', app=IMXApp.CHIP_TOOL_TRUSTY, release=True)
    yield target.Extend('lighting-app-release', app=IMXApp.LIGHT, release=True)
    yield target.Extend('lighting-app-trusty-release', app=IMXApp.LIGHT_TRUSTY, release=True)
    yield target.Extend('thermostat-release', app=IMXApp.THERMOSTAT, release=True)
    yield target.Extend('nxp-thermostat-release', app=IMXApp.NXP_THERMOSTAT, release=True)
    yield target.Extend('nxp-thermostat-trusty-release', app=IMXApp.NXP_THERMOSTAT_TRUSTY, release=True)
