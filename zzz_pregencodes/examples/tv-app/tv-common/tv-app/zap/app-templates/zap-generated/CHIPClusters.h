...
class DLL_EXPORT ContentAppObserverCluster : public ClusterBase
{
public:
    ContentAppObserverCluster(Messaging::ExchangeManager & exchangeManager, const SessionHandle & session, EndpointId endpoint) :
        ClusterBase(exchangeManager, session, endpoint)
    {}
