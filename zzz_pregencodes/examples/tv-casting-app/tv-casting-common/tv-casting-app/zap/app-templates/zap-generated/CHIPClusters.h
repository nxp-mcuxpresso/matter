...
class DLL_EXPORT ContentControlCluster : public ClusterBase
{
public:
    ContentControlCluster(Messaging::ExchangeManager & exchangeManager, const SessionHandle & session, EndpointId endpoint) :
        ClusterBase(exchangeManager, session, endpoint)
    {}
