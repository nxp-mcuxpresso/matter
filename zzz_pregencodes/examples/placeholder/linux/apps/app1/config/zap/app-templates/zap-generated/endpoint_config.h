...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                                 /* ClusterRevision */       \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Unit Localization (server) */                                                                     \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(42), 0x00000000, 1, ZAP_TYPE(ENUM8),                                                          \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(43), 0x00000030, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* WhitePointX */                                          \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(44), 0x00000031, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* WhitePointY */                                          \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(45), 0x00000032, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ColorPointRX */                                         \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(46), 0x00000033, 2, ZAP_TYPE(INT16U),                                                         \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(47), 0x00000036, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ColorPointGX */                                         \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(48), 0x00000037, 2, ZAP_TYPE(INT16U),                                                         \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(49), 0x0000003A, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ColorPointBX */                                         \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(50), 0x0000003B, 2, ZAP_TYPE(INT16U),                                                         \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(51), 0x00004010, 2, ZAP_TYPE(INT16U),                                                         \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(53), 0x00000022, 1, ZAP_TYPE(INT8U),                                                          \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(54), 0x00000032, 1, ZAP_TYPE(INT8U),                                                          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 63, 1878 },                                                                                        \
        { ZAP_CLUSTER_INDEX(63), 21, 525 },                                                                                        \
    }
...
#define ATTRIBUTE_MAX_SIZE (2403)
