...
#define GENERATED_ATTRIBUTE_COUNT 621
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },        /* DeviceTypeList */ \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(14), 0x00000013, 2, ZAP_TYPE(INT16S),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                                 \
                  ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* UnoccupiedCoolingSetpoint */                                                  \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(15), 0x00000014, 2, ZAP_TYPE(INT16S),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                                 \
                  ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* UnoccupiedHeatingSetpoint */                                                  \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(16), 0x00000015, 2, ZAP_TYPE(INT16S),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MinHeatSetpointLimit */                             \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(17), 0x00000016, 2, ZAP_TYPE(INT16S),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MaxHeatSetpointLimit */                             \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(18), 0x00000017, 2, ZAP_TYPE(INT16S),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MinCoolSetpointLimit */                             \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(19), 0x00000018, 2, ZAP_TYPE(INT16S),                                                     \
...
#define GENERATED_CLUSTER_COUNT 83
// clang-format off
...
#define ZAP_FIXED_ENDPOINT_DATA_VERSION_COUNT 55

// This is an array of EmberAfEndpointType structures.
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 63, 1878 }, { ZAP_CLUSTER_INDEX(63), 20, 527 },                                                    \
    }
