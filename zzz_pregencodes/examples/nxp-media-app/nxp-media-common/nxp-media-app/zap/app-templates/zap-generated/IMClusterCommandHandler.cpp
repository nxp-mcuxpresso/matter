...
void DispatchServerCommand(CommandHandler * apCommandObj, const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled = false;
    {
        ...
        case Commands::SetOnDemandRatingThreshold::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfContentControlClusterSetOnDemandRatingThresholdCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::SetScheduledContentRatingThreshold::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfContentControlClusterSetScheduledContentRatingThresholdCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
