...
#define GENERATED_ATTRIBUTE_COUNT 289
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 21, 305 }, { ZAP_CLUSTER_INDEX(21), 4, 63 }, { ZAP_CLUSTER_INDEX(25), 4, 63 },                     \
    }
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    {                                                                                                                              \
        { 0x00000011, 1 }, { 0x00000016, 1 }, { 0x00000202, 2 },                                                                   \
        {                                                                                                                          \
            0x00000202, 2                                                                                                          \
        }                                                                                                                          \
    }
