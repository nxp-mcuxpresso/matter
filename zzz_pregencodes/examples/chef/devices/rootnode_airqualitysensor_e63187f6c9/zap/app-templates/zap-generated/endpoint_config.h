...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },        /* DeviceTypeList */ \
            ...
            { ZAP_SIMPLE_DEFAULT(0x800), 0x00000000, 2, ZAP_TYPE(TEMPERATURE),                                                     \
              ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */                                   \
            { ZAP_SIMPLE_DEFAULT(0x800), 0x00000001, 2, ZAP_TYPE(TEMPERATURE),                                                     \
              ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */                                \
            { ZAP_SIMPLE_DEFAULT(0x800), 0x00000002, 2, ZAP_TYPE(TEMPERATURE),                                                     \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 190 }, { ZAP_CLUSTER_INDEX(16), 15, 59 },                                                      \
    }
