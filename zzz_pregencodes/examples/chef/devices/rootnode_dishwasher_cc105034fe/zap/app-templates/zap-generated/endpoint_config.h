...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MaxTemperature */                                   \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000003, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* Step */                                             \
