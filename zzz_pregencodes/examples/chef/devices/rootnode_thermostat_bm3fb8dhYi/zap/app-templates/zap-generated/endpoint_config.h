...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },        /* DeviceTypeList */ \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(4), 0x00000013, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* UnoccupiedCoolingSetpoint */                        \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(5), 0x00000014, 2, ZAP_TYPE(INT16S),                                                      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 191 }, { ZAP_CLUSTER_INDEX(16), 10, 71 },                                                      \
    }
