...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0), 0x00000010, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* InstalledOpenLimitLift */     \
        { ZAP_SIMPLE_DEFAULT(65534), 0x00000011, 2, ZAP_TYPE(INT16U),                                                              \
          ZAP_ATTRIBUTE_MASK(TOKENIZE) },                                                         /* InstalledClosedLimitLift */   \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000012, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* InstalledOpenLimitTilt */     \
        { ZAP_SIMPLE_DEFAULT(1800), 0x00000013, 2, ZAP_TYPE(INT16U),                                                               \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 14, 141 },                                                                                         \
        { ZAP_CLUSTER_INDEX(14), 5, 59 },                                                                                          \
    }
