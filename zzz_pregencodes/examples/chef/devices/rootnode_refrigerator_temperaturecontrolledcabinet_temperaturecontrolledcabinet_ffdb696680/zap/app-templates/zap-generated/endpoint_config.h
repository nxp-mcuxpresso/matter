...
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 11 ), \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 14, 200 }, { ZAP_CLUSTER_INDEX(14), 1, 4 }, { ZAP_CLUSTER_INDEX(15), 2, 11 },                      \
            { ZAP_CLUSTER_INDEX(17), 2, 11 },                                                                                      \
    }
