...
JNI_METHOD(void, DemandResponseLoadControlCluster, readLoadControlProgramsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DemandResponseLoadControl::Attributes::LoadControlPrograms::TypeInfo;
    std::unique_ptr<CHIPDemandResponseLoadControlLoadControlProgramsAttributeCallback, void (*)(CHIPDemandResponseLoadControlLoadControlProgramsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDemandResponseLoadControlLoadControlProgramsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDemandResponseLoadControlLoadControlProgramsAttributeCallback>);
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readNumberOfLoadControlProgramsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readEventsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DemandResponseLoadControl::Attributes::Events::TypeInfo;
    std::unique_ptr<CHIPDemandResponseLoadControlEventsAttributeCallback, void (*)(CHIPDemandResponseLoadControlEventsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDemandResponseLoadControlEventsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDemandResponseLoadControlEventsAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readActiveEventsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DemandResponseLoadControl::Attributes::ActiveEvents::TypeInfo;
    std::unique_ptr<CHIPDemandResponseLoadControlActiveEventsAttributeCallback, void (*)(CHIPDemandResponseLoadControlActiveEventsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDemandResponseLoadControlActiveEventsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDemandResponseLoadControlActiveEventsAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readNumberOfEventsPerProgramAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readNumberOfTransitionsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readDefaultRandomStartAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readDefaultRandomDurationAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DemandResponseLoadControl::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPDemandResponseLoadControlGeneratedCommandListAttributeCallback, void (*)(CHIPDemandResponseLoadControlGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDemandResponseLoadControlGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDemandResponseLoadControlGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DemandResponseLoadControl::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPDemandResponseLoadControlAcceptedCommandListAttributeCallback, void (*)(CHIPDemandResponseLoadControlAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDemandResponseLoadControlAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDemandResponseLoadControlAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DemandResponseLoadControl::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPDemandResponseLoadControlEventListAttributeCallback, void (*)(CHIPDemandResponseLoadControlEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDemandResponseLoadControlEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDemandResponseLoadControlEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DemandResponseLoadControl::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPDemandResponseLoadControlAttributeListAttributeCallback, void (*)(CHIPDemandResponseLoadControlAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDemandResponseLoadControlAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDemandResponseLoadControlAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DemandResponseLoadControlCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
