...
JNI_METHOD(void, MediaPlaybackCluster, 
  rewind)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jobject audioAdvanceUnmuted,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    ClusterBase * cppCluster;
    ...
    chip::JniReferences::GetInstance().GetOptionalValue(audioAdvanceUnmuted, optionalValue_0);
    if (optionalValue_0) {
      auto & definedValue_0 = request.audioAdvanceUnmuted.Emplace();
...
JNI_METHOD(void, MediaPlaybackCluster, 
  fastForward)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jobject audioAdvanceUnmuted,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    ClusterBase * cppCluster;
...
JNI_METHOD(void, MediaPlaybackCluster, 
  activateAudioTrack)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jstring trackID,jobject audioOutputIndex,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    ClusterBase * cppCluster;
    ...
    ListFreer listFreer;
    chip::app::Clusters::MediaPlayback::Commands::ActivateAudioTrack::Type request;

    std::vector<Platform::UniquePtr<JniByteArray>> cleanupByteArrays;
    std::vector<Platform::UniquePtr<JniUtfString>> cleanupStrings;cleanupStrings.push_back(chip::Platform::MakeUnique<chip::JniUtfString>(env, static_cast<jstring>(trackID)));
        request.trackID = cleanupStrings.back()->charSpan();request.audioOutputIndex = static_cast<std::remove_reference_t<decltype(request.audioOutputIndex)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(audioOutputIndex));
...
JNI_METHOD(void, MediaPlaybackCluster, 
  activateTextTrack)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jstring trackID,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    ClusterBase * cppCluster;
    ...
    ListFreer listFreer;
    chip::app::Clusters::MediaPlayback::Commands::ActivateTextTrack::Type request;

    std::vector<Platform::UniquePtr<JniByteArray>> cleanupByteArrays;
    std::vector<Platform::UniquePtr<JniUtfString>> cleanupStrings;cleanupStrings.push_back(chip::Platform::MakeUnique<chip::JniUtfString>(env, static_cast<jstring>(trackID)));
        request.trackID = cleanupStrings.back()->charSpan();
...
JNI_METHOD(void, MediaPlaybackCluster, 
  deactivateTextTrack)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    ClusterBase * cppCluster;
    ...
    ListFreer listFreer;
    chip::app::Clusters::MediaPlayback::Commands::DeactivateTextTrack::Type request;
...
}JNI_METHOD(void, MediaPlaybackCluster, subscribeSeekRangeStartAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    ...
    onSuccess.release();
    onFailure.release();
}JNI_METHOD(void, MediaPlaybackCluster, subscribeAvailableAudioTracksAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    chip::DeviceLayer::StackLock lock;std::unique_ptr<CHIPMediaPlaybackAvailableAudioTracksAttributeCallback, void (*)(CHIPMediaPlaybackAvailableAudioTracksAttributeCallback *)> onSuccess(Platform::New<CHIPMediaPlaybackAvailableAudioTracksAttributeCallback>(callback, true), chip::Platform::Delete<CHIPMediaPlaybackAvailableAudioTracksAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
    ...
    err = cppCluster->SubscribeAttribute<TypeInfo>(onSuccess->mContext, successFn->mCall, failureFn->mCall, static_cast<uint16_t>(minInterval), static_cast<uint16_t>(maxInterval), CHIPMediaPlaybackAvailableAudioTracksAttributeCallback::OnSubscriptionEstablished);
    VerifyOrReturn(err == CHIP_NO_ERROR, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error subscribing to attribute", err));

    onSuccess.release();
    onFailure.release();
}JNI_METHOD(void, MediaPlaybackCluster, subscribeAvailableTextTracksAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    chip::DeviceLayer::StackLock lock;std::unique_ptr<CHIPMediaPlaybackAvailableTextTracksAttributeCallback, void (*)(CHIPMediaPlaybackAvailableTextTracksAttributeCallback *)> onSuccess(Platform::New<CHIPMediaPlaybackAvailableTextTracksAttributeCallback>(callback, true), chip::Platform::Delete<CHIPMediaPlaybackAvailableTextTracksAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
    ...
    err = cppCluster->SubscribeAttribute<TypeInfo>(onSuccess->mContext, successFn->mCall, failureFn->mCall, static_cast<uint16_t>(minInterval), static_cast<uint16_t>(maxInterval), CHIPMediaPlaybackAvailableTextTracksAttributeCallback::OnSubscriptionEstablished);
    VerifyOrReturn(err == CHIP_NO_ERROR, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error subscribing to attribute", err));
