...
JNI_METHOD(void, WakeOnLanCluster, readMACAddressAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
...
JNI_METHOD(void, WakeOnLanCluster, readLinkLocalAddressAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::WakeOnLan::Attributes::LinkLocalAddress::TypeInfo;
    ...
    auto successFn = chip::Callback::Callback<CHIPWakeOnLanClusterLinkLocalAddressAttributeCallbackType>::FromCancelable(onSuccess->Cancel());
    auto failureFn = chip::Callback::Callback<CHIPDefaultFailureCallbackType>::FromCancelable(onFailure->Cancel());
    err = cppCluster->ReadAttribute<TypeInfo>(onSuccess->mContext, successFn->mCall, failureFn->mCall);
    VerifyOrReturn(err == CHIP_NO_ERROR, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error reading attribute", err));
...
JNI_METHOD(void, WakeOnLanCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::WakeOnLan::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPWakeOnLanGeneratedCommandListAttributeCallback, void (*)(CHIPWakeOnLanGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPWakeOnLanGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPWakeOnLanGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, WakeOnLanCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::WakeOnLan::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPWakeOnLanAcceptedCommandListAttributeCallback, void (*)(CHIPWakeOnLanAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPWakeOnLanAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPWakeOnLanAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, WakeOnLanCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::WakeOnLan::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPWakeOnLanEventListAttributeCallback, void (*)(CHIPWakeOnLanEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPWakeOnLanEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPWakeOnLanEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, WakeOnLanCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    ...
    std::unique_ptr<CHIPWakeOnLanAttributeListAttributeCallback, void (*)(CHIPWakeOnLanAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPWakeOnLanAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPWakeOnLanAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, WakeOnLanCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
