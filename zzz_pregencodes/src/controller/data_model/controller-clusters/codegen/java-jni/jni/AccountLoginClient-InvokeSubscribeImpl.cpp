...
JNI_METHOD(void, AccountLoginCluster, 
  getSetupPIN)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jstring tempAccountIdentifier,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    ...
    std::vector<Platform::UniquePtr<JniUtfString>> cleanupStrings;cleanupStrings.push_back(chip::Platform::MakeUnique<chip::JniUtfString>(env, static_cast<jstring>(tempAccountIdentifier)));
        request.tempAccountIdentifier = cleanupStrings.back()->charSpan();

  
    std::unique_ptr<CHIPAccountLoginClusterGetSetupPINResponseCallback, void (*)(CHIPAccountLoginClusterGetSetupPINResponseCallback *)> onSuccess(
        Platform::New<CHIPAccountLoginClusterGetSetupPINResponseCallback>(callback), Platform::Delete<CHIPAccountLoginClusterGetSetupPINResponseCallback>);
    ...
    auto successFn = chip::Callback::Callback<CHIPAccountLoginClusterGetSetupPINResponseCallbackType>::FromCancelable(onSuccess->Cancel());
...
JNI_METHOD(void, AccountLoginCluster, 
  login)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jstring tempAccountIdentifier,jstring setupPIN,jobject node,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    ClusterBase * cppCluster;
    ...
    std::vector<Platform::UniquePtr<JniByteArray>> cleanupByteArrays;
    std::vector<Platform::UniquePtr<JniUtfString>> cleanupStrings;cleanupStrings.push_back(chip::Platform::MakeUnique<chip::JniUtfString>(env, static_cast<jstring>(tempAccountIdentifier)));
        request.tempAccountIdentifier = cleanupStrings.back()->charSpan();cleanupStrings.push_back(chip::Platform::MakeUnique<chip::JniUtfString>(env, static_cast<jstring>(setupPIN)));
        request.setupPIN = cleanupStrings.back()->charSpan();{
    jobject optionalValue_0 = nullptr;
    chip::JniReferences::GetInstance().GetOptionalValue(node, optionalValue_0);
    if (optionalValue_0) {
      auto & definedValue_0 = request.node.Emplace();
...
JNI_METHOD(void, AccountLoginCluster, 
  logout)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback,jobject node,jobject timedInvokeTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    ClusterBase * cppCluster;
...
JNI_METHOD(void, AccountLoginCluster, subscribeGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    chip::DeviceLayer::StackLock lock;std::unique_ptr<CHIPAccountLoginGeneratedCommandListAttributeCallback, void (*)(CHIPAccountLoginGeneratedCommandListAttributeCallback *)> onSuccess(Platform::New<CHIPAccountLoginGeneratedCommandListAttributeCallback>(callback, true), chip::Platform::Delete<CHIPAccountLoginGeneratedCommandListAttributeCallback>);
    ...
    err = cppCluster->SubscribeAttribute<TypeInfo>(onSuccess->mContext, successFn->mCall, failureFn->mCall, static_cast<uint16_t>(minInterval), static_cast<uint16_t>(maxInterval), CHIPAccountLoginGeneratedCommandListAttributeCallback::OnSubscriptionEstablished);
    ...
    onSuccess.release();
    onFailure.release();
}JNI_METHOD(void, AccountLoginCluster, subscribeAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    chip::DeviceLayer::StackLock lock;std::unique_ptr<CHIPAccountLoginAcceptedCommandListAttributeCallback, void (*)(CHIPAccountLoginAcceptedCommandListAttributeCallback *)> onSuccess(Platform::New<CHIPAccountLoginAcceptedCommandListAttributeCallback>(callback, true), chip::Platform::Delete<CHIPAccountLoginAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
    ...
    err = cppCluster->SubscribeAttribute<TypeInfo>(onSuccess->mContext, successFn->mCall, failureFn->mCall, static_cast<uint16_t>(minInterval), static_cast<uint16_t>(maxInterval), CHIPAccountLoginAcceptedCommandListAttributeCallback::OnSubscriptionEstablished);
    VerifyOrReturn(err == CHIP_NO_ERROR, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error subscribing to attribute", err));

    onSuccess.release();
    onFailure.release();
}JNI_METHOD(void, AccountLoginCluster, subscribeEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    chip::DeviceLayer::StackLock lock;std::unique_ptr<CHIPAccountLoginEventListAttributeCallback, void (*)(CHIPAccountLoginEventListAttributeCallback *)> onSuccess(Platform::New<CHIPAccountLoginEventListAttributeCallback>(callback, true), chip::Platform::Delete<CHIPAccountLoginEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
    ...
    err = cppCluster->SubscribeAttribute<TypeInfo>(onSuccess->mContext, successFn->mCall, failureFn->mCall, static_cast<uint16_t>(minInterval), static_cast<uint16_t>(maxInterval), CHIPAccountLoginEventListAttributeCallback::OnSubscriptionEstablished);
    VerifyOrReturn(err == CHIP_NO_ERROR, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error subscribing to attribute", err));

    onSuccess.release();
    onFailure.release();
}JNI_METHOD(void, AccountLoginCluster, subscribeAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    chip::DeviceLayer::StackLock lock;std::unique_ptr<CHIPAccountLoginAttributeListAttributeCallback, void (*)(CHIPAccountLoginAttributeListAttributeCallback *)> onSuccess(Platform::New<CHIPAccountLoginAttributeListAttributeCallback>(callback, true), chip::Platform::Delete<CHIPAccountLoginAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
    ...
    err = cppCluster->SubscribeAttribute<TypeInfo>(onSuccess->mContext, successFn->mCall, failureFn->mCall, static_cast<uint16_t>(minInterval), static_cast<uint16_t>(maxInterval), CHIPAccountLoginAttributeListAttributeCallback::OnSubscriptionEstablished);
    VerifyOrReturn(err == CHIP_NO_ERROR, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error subscribing to attribute", err));

    onSuccess.release();
    onFailure.release();
}JNI_METHOD(void, AccountLoginCluster, subscribeFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
    ...
    onSuccess.release();
    onFailure.release();
}JNI_METHOD(void, AccountLoginCluster, subscribeClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint minInterval, jint maxInterval)
{
