...
JNI_METHOD(void, DeviceEnergyManagementCluster, readESATypeAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readESACanGenerateAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readESAStateAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readAbsMinPowerAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readAbsMaxPowerAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readPowerAdjustmentCapabilityAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DeviceEnergyManagement::Attributes::PowerAdjustmentCapability::TypeInfo;
    std::unique_ptr<CHIPDeviceEnergyManagementPowerAdjustmentCapabilityAttributeCallback, void (*)(CHIPDeviceEnergyManagementPowerAdjustmentCapabilityAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDeviceEnergyManagementPowerAdjustmentCapabilityAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDeviceEnergyManagementPowerAdjustmentCapabilityAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DeviceEnergyManagement::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPDeviceEnergyManagementGeneratedCommandListAttributeCallback, void (*)(CHIPDeviceEnergyManagementGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDeviceEnergyManagementGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDeviceEnergyManagementGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DeviceEnergyManagement::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPDeviceEnergyManagementAcceptedCommandListAttributeCallback, void (*)(CHIPDeviceEnergyManagementAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDeviceEnergyManagementAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDeviceEnergyManagementAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DeviceEnergyManagement::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPDeviceEnergyManagementEventListAttributeCallback, void (*)(CHIPDeviceEnergyManagementEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDeviceEnergyManagementEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDeviceEnergyManagementEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::DeviceEnergyManagement::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPDeviceEnergyManagementAttributeListAttributeCallback, void (*)(CHIPDeviceEnergyManagementAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPDeviceEnergyManagementAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPDeviceEnergyManagementAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, DeviceEnergyManagementCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
