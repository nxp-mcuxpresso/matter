...
JNI_METHOD(void, LaundryDryerControlsCluster, readSupportedDrynessLevelsAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::LaundryDryerControls::Attributes::SupportedDrynessLevels::TypeInfo;
    std::unique_ptr<CHIPLaundryDryerControlsSupportedDrynessLevelsAttributeCallback, void (*)(CHIPLaundryDryerControlsSupportedDrynessLevelsAttributeCallback *)> onSuccess(chip::Platform::New<CHIPLaundryDryerControlsSupportedDrynessLevelsAttributeCallback>(callback, false), chip::Platform::Delete<CHIPLaundryDryerControlsSupportedDrynessLevelsAttributeCallback>);
...
JNI_METHOD(void, LaundryDryerControlsCluster, readSelectedDrynessLevelAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::LaundryDryerControls::Attributes::SelectedDrynessLevel::TypeInfo;
    std::unique_ptr<CHIPLaundryDryerControlsSelectedDrynessLevelAttributeCallback, void (*)(CHIPLaundryDryerControlsSelectedDrynessLevelAttributeCallback *)> onSuccess(chip::Platform::New<CHIPLaundryDryerControlsSelectedDrynessLevelAttributeCallback>(callback, false), chip::Platform::Delete<CHIPLaundryDryerControlsSelectedDrynessLevelAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, LaundryDryerControlsCluster, readGeneratedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::LaundryDryerControls::Attributes::GeneratedCommandList::TypeInfo;
    std::unique_ptr<CHIPLaundryDryerControlsGeneratedCommandListAttributeCallback, void (*)(CHIPLaundryDryerControlsGeneratedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPLaundryDryerControlsGeneratedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPLaundryDryerControlsGeneratedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, LaundryDryerControlsCluster, readAcceptedCommandListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::LaundryDryerControls::Attributes::AcceptedCommandList::TypeInfo;
    std::unique_ptr<CHIPLaundryDryerControlsAcceptedCommandListAttributeCallback, void (*)(CHIPLaundryDryerControlsAcceptedCommandListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPLaundryDryerControlsAcceptedCommandListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPLaundryDryerControlsAcceptedCommandListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, LaundryDryerControlsCluster, readEventListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::LaundryDryerControls::Attributes::EventList::TypeInfo;
    std::unique_ptr<CHIPLaundryDryerControlsEventListAttributeCallback, void (*)(CHIPLaundryDryerControlsEventListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPLaundryDryerControlsEventListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPLaundryDryerControlsEventListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, LaundryDryerControlsCluster, readAttributeListAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
    using TypeInfo = chip::app::Clusters::LaundryDryerControls::Attributes::AttributeList::TypeInfo;
    std::unique_ptr<CHIPLaundryDryerControlsAttributeListAttributeCallback, void (*)(CHIPLaundryDryerControlsAttributeListAttributeCallback *)> onSuccess(chip::Platform::New<CHIPLaundryDryerControlsAttributeListAttributeCallback>(callback, false), chip::Platform::Delete<CHIPLaundryDryerControlsAttributeListAttributeCallback>);
    VerifyOrReturn(onSuccess.get() != nullptr, chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(env, callback, "Error creating native success callback", CHIP_ERROR_NO_MEMORY));
...
JNI_METHOD(void, LaundryDryerControlsCluster, readFeatureMapAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
...
JNI_METHOD(void, LaundryDryerControlsCluster, readClusterRevisionAttribute)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback)
{
    chip::DeviceLayer::StackLock lock;
