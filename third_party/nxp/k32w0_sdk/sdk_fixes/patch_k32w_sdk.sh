...
convert_to_dos "$NXP_K32W0_SDK_ROOT"/boards/${board}/wireless_examples/openthread/reed/bm/board.c
...
patch -N --binary -d "$NXP_K32W0_SDK_ROOT"/boards/${board}/wireless_examples/openthread/reed/bm/ -p1 <"$SOURCE_DIR/board_c.patch"
