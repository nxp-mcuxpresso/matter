...
static EntropyContext gsEntropyContext __attribute__((section(".data")));
...
CHIP_ERROR P256Keypair::ECDH_derive_secret(const P256PublicKey & remote_public_key, P256ECDHDerivedSecret & out_secret) const
{
    ...
    VerifyOrExit(SSS_KEY_STORE_GET_PUBKEY(&sharedSecret, Uint8::to_uchar(out_secret), &coordinateLen, &coordinateBitsLen) == kStatus_SSS_Success,
                                          CHIP_ERROR_INTERNAL);
