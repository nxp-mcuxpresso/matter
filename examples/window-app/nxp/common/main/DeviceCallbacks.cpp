...
void WindowCoveringApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
WindowCoveringApp::DeviceCallbacks & WindowCoveringApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return WindowCoveringApp::DeviceCallbacks::GetDefaultInstance();
}
