...
void AirQualitySensorApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
AirQualitySensorApp::DeviceCallbacks & AirQualitySensorApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return AirQualitySensorApp::DeviceCallbacks::GetDefaultInstance();
}
