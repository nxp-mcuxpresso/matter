...
- K32W041AM flavor
    ...
    Exactly the same steps as above but set argument build_for_k32w041am=1 in the gn command and use [K32W041AMDK6 SDK 2.6.10](https://cache.nxp.com/lgfiles/bsps/SDK_2_6_10_K32W041AMDK6.zip).
