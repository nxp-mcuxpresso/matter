...
void SmokeCOAlarmApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
SmokeCOAlarmApp::DeviceCallbacks & SmokeCOAlarmApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return SmokeCOAlarmApp::DeviceCallbacks::GetDefaultInstance();
}
