# Matter MW320 Light-Switch-Combo Example Application
...
-   [Matter MW320 Light_Switch_Combo Example Application](#matter-mw320-light-switch-combo-example-application)
...
```
$ cd examples/light-switch-combo-app/nxp/mw320/
...
Example application binary file "chip-mw320-light-switch-combo-example.bin" will be
...
$ mw320_sdk/tools/mw_img_conv/bin/mw_img_conv mcufw out/debug/chip-mw320-light-switch-combo-example.bin out/debug/chip-mw320-light-switch-combo-app.mcufw.bin 0x1F010000
$ cp out/debug/chip-mw320-light-switch-combo-app.mcufw.bin mw320_sdk/mw320_matter_flash/Matter/.
```
...
$ sudo python2 flashprog.py -l Matter/layout-4m.txt --boot2 Matter/boot2.bin --wififw Matter/mw32x_uapsta_W14.88.36.p172.bin --mcufw Matter/chip-mw320-light-switch-combo-app.mcufw.bin -r
```
