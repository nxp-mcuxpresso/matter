...
RTOTAProviderExample::RTOTAProviderExample()
{
...
void RTOTAProviderExample::SetOTAFilePath(const char * path)
{
    if (path != nullptr)
    {
...
void RTOTAProviderExample::SetImageUri(const char * imageUri)
{
    if (imageUri != nullptr)
    {
...
void RTOTAProviderExample::SetOTACandidates(std::vector<RTOTAProviderExample::DeviceSoftwareVersionModel> candidates)
{
...
bool RTOTAProviderExample::SelectOTACandidate(const uint16_t requestorVendorID, const uint16_t requestorProductID,
...
UserConsentSubject RTOTAProviderExample::GetUserConsentSubject(const app::CommandHandler * commandObj,
...
bool RTOTAProviderExample::ParseOTAHeader(OTAImageHeaderParser & parser, const char * otaFilePath, OTAImageHeader & header)
{
...
void RTOTAProviderExample::SendQueryImageResponse(app::CommandHandler * commandObj, const app::ConcreteCommandPath & commandPath,
                                                  const QueryImage::DecodableType & commandData)
{
...
void RTOTAProviderExample::HandleQueryImage(app::CommandHandler * commandObj, const app::ConcreteCommandPath & commandPath,
                                            const QueryImage::DecodableType & commandData)
{
    bool requestorCanConsent = commandData.requestorCanConsent.ValueOr(false);
...
void RTOTAProviderExample::HandleApplyUpdateRequest(app::CommandHandler * commandObj, const app::ConcreteCommandPath & commandPath,
...
void RTOTAProviderExample::HandleNotifyUpdateApplied(app::CommandHandler * commandObj, const app::ConcreteCommandPath & commandPath,
