 ...
 */
class RTOTAProviderExample : public chip::app::Clusters::OTAProviderDelegate
{
public:
    RTOTAProviderExample();
    ...
    RTBdxOtaSender * GetBdxOtaSender() { return &mBdxOtaSender; }

    void SetOTACandidates(std::vector<RTOTAProviderExample::DeviceSoftwareVersionModel> candidates);
