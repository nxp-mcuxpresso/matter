...
RT1060 SDK. The example supports basic ZCL commands and acts as a thermostat
device-type.

The example supports:

-   Matter over wi-fi. For that follow instructions from
...
Refer to the Building section in ethernet, wi-fi or openthread specific README
file.
