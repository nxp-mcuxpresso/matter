...
void TemperatureSensorApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
TemperatureSensorApp::DeviceCallbacks & TemperatureSensorApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return TemperatureSensorApp::DeviceCallbacks::GetDefaultInstance();
}
